...
const links = [["Services","/services"],["Capabilities","/capabilities"],["Projects","/projects"],["Process","/process"],["About","/about"],["Contact","/contact"]];
export function SiteHeader() {
  return <header className="sticky top-0 z-40 border-b border-black/15 bg-[var(--paper)]/95 backdrop-blur-sm">
    <div className="wrap flex min-h-20 items-center justify-between gap-5">
      <Link href="/" aria-label="Flowcoat home" className="text-2xl font-black tracking-[-.075em]">FLOW<span className="text-[var(--brand)]">COAT</span></Link>

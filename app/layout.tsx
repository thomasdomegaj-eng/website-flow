...
export const metadata:Metadata={metadataBase:new URL(siteUrl),title:{default:"FLOWCOAT | Commercial Powder Coating in Sydney",template:"%s | FLOWCOAT"},description:"Commercial powder coating for metal parts, fabrications, architectural metalwork and production batches across Sydney.",openGraph:{title:"FLOWCOAT | Commercial Powder Coating in Sydney",description:"Professional powder coating for metal parts across Sydney.",url:siteUrl,siteName:"FLOWCOAT",type:"website"}};
